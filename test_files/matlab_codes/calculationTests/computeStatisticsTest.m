            ...
            testCase.GRNstruct.expressionData = struct( ...
              'expressionData', struct(...
                  ...
                  'raw', {[0.4	0.4	0.4	0.8	0.8	0.8	1.2	1.2	1.2;...
                          1	1	1	1	-0.706666467343382	-0.706666467343382	-0.987239299670092	-0.987239299670092	-0.987239299670092;...
        ...
        function testWithMultipleMissingDataPoints (testCase)
            ...
            testCase.GRNstruct =  struct( ...
                 'expressionData', struct(...
                     ...
                     'raw', {[0.4  0.4  0.4	0.8	0.8	0.8	1.2	1.2	1.2;...
                              1	   1	2	1	1	1	 NaN   2	2;...
                              2	-0.227718654239836	 NaN                -0.408017743026565	-0.408017743026565	-0.408017743026565	-0.546412653239117	-0.546412653239117	-0.546412653239117;...
