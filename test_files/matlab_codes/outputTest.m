...
%           Test if graphs are made only when they're supposed to
            if testCase.GRNstruct.controlParams.make_graphs
                testCase.verifyEqual(exist([tempdir '\ACE2.jpg'], 'file'),...
                                     2,...
                                     testCase.GRNstruct.inputFile);
                testCase.verifyEqual(exist([tempdir '\AFT2.jpg'], 'file'), ...
                                     2,...
                                     testCase.GRNstruct.inputFile);
                testCase.verifyEqual(exist([tempdir '\CIN5.jpg'], 'file'), ...
                                     2,...
                                     testCase.GRNstruct.inputFile);
                testCase.verifyEqual(exist([tempdir '\FHL1.jpg'], 'file'), ...
                                     2,...
                                     testCase.GRNstruct.inputFile);
            else
                testCase.verifyEqual(exist([tempdir '\ACE2.jpg'], 'file'), ...
