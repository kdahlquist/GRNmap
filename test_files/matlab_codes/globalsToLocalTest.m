...
%         end
        ...
        function testLog2FCAssignedCorrectly(testCase)
           testCase.verifyEqual(testCase.GRNstruct.GRNModel(1).model, [0	-0.0898003214492152	-0.177837235669622	-0.264143175465653;...
                                                                       0	-0.0535544725451915	-0.105340331017462	-0.155412951361923	;...
                                                                       0	 0.0743459203142814	 0.138786287342172	 0.195043980758031	;...
                                                                       0	-0.0586045566610957	-0.116780839243491	-0.174488024612268]);
           testCase.verifyEqual(testCase.GRNstruct.GRNModel(2).model, [0	-0.0898003214492152	-0.177837235669622	-0.264143175465653; ...
                                                                       0	-0.0535544725451915	-0.105340331017462	-0.155412951361923; ...
                                                                       0	 0	                 0                   0	; ...
                                                                       0	-0.0458513259283481	-0.0908341460604173	-0.134976605186563]);
        end
